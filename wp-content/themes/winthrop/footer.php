    	...
    	<section id="contact-detail">
        	<div class="container">
            	<div class="container-inner clearfix">
                    <div class="contact">
                        <h5>Contact Us</h5>
                        <p class="address first"><?php the_field('address', $o); ?></p>
                        <p class="address"><?php the_field('address_line_2', $o); ?></p>
                    	...
                    	<?php $FooterMenu = array('menu' => 'footer', 'container' => 'nav', 'container_class' => '', 'container_id' => 'footer-nav', 'menu_class' => 'menu', 'menu_id' => '', 'echo' => true, 'fallback_cb' => 'wp_page_menu', 'before' => '', 'after' => '', 'link_before' => '', 'link_after' => '', 'items_wrap' => '<ul id="%1$s" class="%2$s">%3$s</ul>', 'depth' => 2, 'walker'  => ''); wp_nav_menu($FooterMenu); ?>
                 </div>
            </div>
        </section>
        ...
        <section id="copyright">
        	<div class="container">
            	<div class="container-inner int">
            		<p><strong>Copyright <?php echo the_date('Y'); ?> Winthrop Wealth Management</strong></p>
