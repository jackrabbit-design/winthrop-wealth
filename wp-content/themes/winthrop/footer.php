        	...
        	<div class="container">
            	<div class="container-inner int">
                    <div class="row-one">
                    	...
                    	<?php $FooterMenu = array('menu' => 'main-menu', 'container' => 'nav', 'container_class' => 'hidden-s', 'container_id' => 'footer-nav', 'menu_class' => 'menu', 'menu_id' => '', 'echo' => true, 'fallback_cb' => 'wp_page_menu', 'before' => '', 'after' => '', 'link_before' => '', 'link_after' => '', 'items_wrap' => '<ul id="%1$s" class="%2$s">%3$s</ul>', 'depth' => 2, 'walker'  => ''); wp_nav_menu($FooterMenu); ?>
                 </div>
            </div>
        </section>
