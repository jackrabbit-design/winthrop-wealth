...
$postNameSingular = 'Team Posts'; // Singular Name
$postNamePlural   = 'Team Posts'; // Plural Name
register_post_type(
	$postNameSlug, array(
		'labels' => array(
	       'name' => $postName,
...
$postNameSingular = 'Video Post'; // Singular Name
$postNamePlural   = 'Video Posts'; // Plural Name
register_post_type(
	$postNameSlug, array(
		'labels' => array(
	       'name' => $postName,
...
$taxonomyName         = 'Video Type';
$taxonomyNameSlug     = 'video-type';
$taxonomyNameSingular = 'Video Type';
$taxonomyNamePlural   = 'Video Types';
register_taxonomy(
