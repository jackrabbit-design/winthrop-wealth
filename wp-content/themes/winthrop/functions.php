...
add_image_size( 'inner-banner', 1600, 221, true);
add_image_size( 'hero', 1600, 641, true);
...
add_image_size( 'head-shot', 222, 150, true);
add_image_size( 'resource-icon', 200, 9999, false);
add_image_size( 'blog-size', 443, 202, true);
//add_image_size( 'inner-banner', 100, 100, true);443/202
...
// Options Page variable... For Lazy Developers. replaces this the_field('feildname', options);
